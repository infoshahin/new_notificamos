<?php $edit_data = $this->db->get_where('categories', array('id' => $param2))->result_array();
?>
    ...
    <div class="rrow scroll-y" id="mainYScroller">
        <div class="inner topRight">
            <ul class="breadcrumb">
                ...
                <li class="divider"></li>
                <li>Edit Categorie</li>
            </ul>
            <div class="separator"></div>
            <?php echo form_open('admin/update_categories/' . $param2 . '', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
            <div class="heading-buttons">
                <h2 class="glyphicons cart_in"><i></i> Edit Categorie</h2>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="productDescriptionTab">
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                    <label for="inputEmail">Categorie title</label>
                                    <?php $query = $this->db->get('categories')->result_array(); ?>
                                    <select name="parent_id">
                                        <?php foreach ($query as $row): ?>
                                            <option
                                                value="<?php echo $row['id'] ?>" <?php if ($row['id'] == $edit_data[0]['parent_id']) {
                                                echo 'selected';
                            ...
                            <div class="row-fluid">
                                <div class="span3">
                                    <strong>New Categorie</strong>

                                    <p class="muted"></p>
                                </div>
                                <div class="span9">
                                    <label for="inputEmail">New Categorie</label>
