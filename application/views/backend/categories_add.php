<div class="span10 col main-right">
    <div class="rrow scroll-y" id="mainYScroller">
        <div class="inner topRight">
            ...
            <?php echo form_open('admin/categories_information/create', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
            <div class="heading-buttons">
                <h2 class="glyphicons cart_in"><i></i> Add Categorie</h2>
                        ...
                        <div class="tab-pane active" id="productDescriptionTab">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                    ...
                                    <input type="text" name="title" id="mustHaveId" class="wysihtml5 span12"/>
                                </div>
                            </div>
